...
class Settings(BaseSettings):
    ...
    JWT_SECRET = Field(..., description="JWT signing secret")
    JWT_ALGORITHM = Field("HS256", description="JWT algorithm")
    JWT_ACCESS_TOKEN_EXPIRES_MIN  = Field(60, description="Access Token TTL in minutes")
